...
if __name__ == "__main__":
    ...
    task = clearml.Task.init(project_name="UR-DMU", task_name="KD75 noise", task_type=Task.TaskTypes.training)
        ...
        if step % 10 == 0 and step >= 10:
            ...
            if test_info["auc"][-1] > best_auc:
                ...
                utils.save_best_record(test_info, 
                    os.path.join(config.output_path, "ucf_KD75_noise_best_record_{}.txt".format(config.seed)))
