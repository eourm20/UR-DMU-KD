...
if __name__ == "__main__":
    ...
    # )
    # task = clearml.Task.init(project_name="UR-DMU-HPE3", task_name="KD_res_5", task_type=Task.TaskTypes.training)
    ...
    for step in tqdm(
        ...
        if test_info["auc"][-1] > best_auc:
            ...
            utils.save_best_record(test_info, 
                os.path.join(config.output_path, "KD_noise75_3(HP)_best_record.txt"))
