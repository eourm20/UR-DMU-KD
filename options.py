...
def parse_args():
    ...
    parser.add_argument('--lr', type = str, default = '[0.0001]*500', help = 'learning rates for steps(list form)')
    ...
    parser.add_argument('--model_file', type = str, default = "label25(HP2)_{}.pkl".format(seed), help = 'the path of pre-trained model file')
    parser.add_argument('--debug', action = 'store_true')
    parser.add_argument('--HPLoss_w', type = float, default = 0.25, help = 'weight of HP Loss')
