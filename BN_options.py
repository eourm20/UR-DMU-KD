...
def parse_args():
    ...
    parser.add_argument('--root_dir', type = str, default = 'outputs/BN_WVAD/')
    parser.add_argument('--log_path', type = str, default = 'logs/BN_WVAD/')
    
    parser.add_argument('--model_path', type = str, default = 'models/BN_WVAD/')
    ...
    parser.add_argument('--model_file', type = str, default = "XD_ALL(HPE)5.pkl", help = 'the path of pre-trained model file')
    # parser.add_argument('--model_file', type = str, default = "UCF_ALL(HPE)5.pkl", help = 'the path of pre-trained model file')
    # parser.add_argument('--HPLoss_w', type = float, default = 0.5, help = 'weight of HP Loss')#for UCF
    parser.add_argument('--HPLoss_w', type = float, default = 1, help = 'weight of HP Loss')# for XD
