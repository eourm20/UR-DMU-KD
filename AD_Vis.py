...
def cv2show(video_path, score_list, normal):
    ...
    out = cv2.VideoWriter(f'video_score/{file_name}_Teacher_more_train.mp4', fourcc, fps, (width, height + plot_height))
...
if __name__=="__main__":
    ...
    ad_net.load_state_dict(torch.load("models/trans_Teacher_More_Train_2022.pkl"))
    ad_net.cuda()
